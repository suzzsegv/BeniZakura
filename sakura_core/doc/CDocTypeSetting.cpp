...
static ColorInfoIni ColorInfo_DEFAULT[COLOR_THEME_MAX][COLORIDX_LAST] = {
	/* 紅桜 */
	{
		...
		_T("カーソル(IME ON)"),					TRUE,		FALSE,		FALSE,		RGB( 0xff,0x30,0x30 ),	RGB( 0x00,0x00,0x00 ),
		...
		_T("半角数値"),							TRUE,		FALSE,		FALSE,		RGB( 0xff,0x30,0x30 ),	RGB( 0x00,0x00,0x00 ),
		_T("対括弧の強調表示"),					TRUE,		FALSE,		FALSE,		RGB( 0xff,0xff,0xff ),	RGB( 0xff,0x30,0x30 ),
		_T("選択範囲"),							TRUE,		FALSE,		FALSE,		RGB( 0xff,0xff,0x00 ),	RGB( 0xff,0xff,0x00 ),
		_T("検索文字列"),						TRUE,		FALSE,		FALSE,		RGB( 0xff,0xff,0x00 ),	RGB( 0x00,0x00,0xff ),
		_T("検索文字列2"),						TRUE,		FALSE,		FALSE,		RGB( 0xff,0xff,0x00 ),	RGB( 0x00,0x00,0xff ),
		_T("検索文字列3"),						TRUE,		FALSE,		FALSE,		RGB( 0xff,0xff,0x00 ),	RGB( 0x00,0x00,0xff ),
		_T("検索文字列4"),						TRUE,		FALSE,		FALSE,		RGB( 0xff,0xff,0x00 ),	RGB( 0x00,0x00,0xff ),
		_T("検索文字列5"),						TRUE,		FALSE,		FALSE,		RGB( 0xff,0xff,0x00 ),	RGB( 0x00,0x00,0xff ),
		_T("コメント"),							TRUE,		FALSE,		FALSE,		RGB( 0x00,0xc0,0x00 ),	RGB( 0x00,0x00,0x00 ),
		_T("C/C++ プリプロセッサコメント"),		TRUE,		FALSE,		FALSE,		RGB( 0x80,0x80,0x80 ),	RGB( 0x00,0x00,0x00 ),
		_T("シングルクォーテーション文字列"),	TRUE,		FALSE,		FALSE,		RGB( 0xff,0x30,0x30 ),	RGB( 0x00,0x00,0x00 ),
		_T("ダブルクォーテーション文字列"),		TRUE,		FALSE,		FALSE,		RGB( 0xff,0x30,0x30 ),	RGB( 0x00,0x00,0x00 ),
		_T("URL"),								TRUE,		FALSE,		TRUE,		RGB( 0x80,0x80,0xff ),	RGB( 0x00,0x00,0x00 ),
		_T("強調キーワード1"),					TRUE,		FALSE,		FALSE,		RGB( 0xff,0x80,0x00 ),	RGB( 0x00,0x00,0x00 ),
		...
		_T("強調キーワード4"),					TRUE,		FALSE,		FALSE,		RGB( 0xff,0x30,0x30 ),	RGB( 0x00,0x00,0x00 ),
		_T("強調キーワード5"),					TRUE,		FALSE,		FALSE,		RGB( 0xff,0x00,0x80 ),	RGB( 0x00,0x00,0x00 ),
		_T("強調キーワード6"),					TRUE,		FALSE,		FALSE,		RGB( 0xff,0x80,0x00 ),	RGB( 0x00,0x00,0x00 ),
		...
		_T("正規表現キーワード1"),				TRUE,		FALSE,		FALSE,		RGB( 0x98,0xfb,0x98 ),	RGB( 0x00,0x00,0x00 ),
	...
	/* サクラエディタ */
	{
		...
		_T("選択範囲"),							TRUE,		FALSE,		FALSE,		RGB(  49, 106, 197 ),	RGB(  49, 106, 197 ),
